...
Validators should call `get_ptc_assignment(state, get_current_epoch(state),
validator_index)` at the beginning of the epoch to determine the slot during
the current epoch in which they should submit their PTC attestation.
